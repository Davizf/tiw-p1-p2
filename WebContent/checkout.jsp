									...
									<tr>
										...
										<td class="details">
											...
											<td class="price text-center">
												<%if (!product.getProduct().getSalePrice().equals(product.getProduct().getPrice())) {%>
													<del class="font-weak"><small>$<%=product.getProduct().getPrice().doubleValue() %></small></del><br>
												<%} %>
												<strong>$<%=product.getProduct().getSalePrice().doubleValue() %></strong>
											</td>
