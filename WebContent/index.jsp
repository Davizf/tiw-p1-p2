		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-md-4 col-sm-6">
					<a class="banner banner-1" href="#">
						<img src="/tiw-p1/images/banner10.jpg" alt="">
						<div class="banner-caption text-center">
							<h2 class="white-color">NEW COLLECTION</h2>
						</div>
					</a>
				...
				<div class="col-md-4 col-sm-6">
					<a class="banner banner-1" href="#">
						<img src="/tiw-p1/images/banner11.jpg" alt="">
						<div class="banner-caption text-center">
							<h2 class="white-color">NEW COLLECTION</h2>
						</div>
					</a>
				...
				<div class="col-md-4 col-md-offset-0 col-sm-6 col-sm-offset-3">
					<a class="banner banner-1" href="#">
						<img src="/tiw-p1/images/banner12.jpg" alt="">
						<div class="banner-caption text-center">
							<h2 class="white-color">NEW COLLECTION</h2>
						</div>
					</a>
			...
			<div class="row">
				...
				<div class="col-md-3 col-sm-6 col-xs-6">
					<div class="banner banner-2">
						<img src="/tiw-p1/images/banner14.jpg" alt="">
						<div class="banner-caption">
	...
	<div class="section section-grey">
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-md-8">
					<div class="banner banner-1">
						<img src="/tiw-p1/images/banner13.jpg" alt="">
						<div class="banner-caption text-center">
							<h1 class="primary-color">HOT DEAL<br><span class="white-color font-weak">Up to 50% OFF</span></h1>
							<button class="primary-btn">Shop Now</button>
						</div>
	...
	<div class="section">
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-md-3 col-sm-6 col-xs-6">
					<div class="banner banner-2">
						<img src="/tiw-p1/images/banner15.jpg" alt="">
						<div class="banner-caption">
							<h2 class="white-color">NEW<br>COLLECTION</h2>
							<button class="primary-btn">Shop Now</button>
						</div>
